        ...
        <ScrollView style={{ flex: 1, backgroundColor: "#f7f7f7" }}>
          <Content>
            <Grid>
              <Col style={[styles.ColMateri]}>
                ...
                <Text style={{ color: 'grey' }}>
                  Operator Logika digunakan untuk memeriksa kesamaan nilai dari dua data atau lebih dan
                  juga ada yang dapat mengembalikan nilai dari bilangan <B>Boolean</B>.
								</Text>
                <Image
                  source={require('../../../assets/images/logical-table.png')}
                  resizeMode='contain'
                  fadeDuration={0}
            ...
            <Grid>
              ...
              <Col style={{ flex: 1, justifyContent: 'center', alignContent: 'center' }}>
                <Button style={[styles.nextButton, styles.midBut]} onPress={() => this.props.navigation.navigate('incDecScreen')}>
