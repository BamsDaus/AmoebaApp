        ...
        <ScrollView style={{ flex: 1, backgroundColor: "#f7f7f7" }}>
          <Content>
            <Grid>
              <Col style={[styles.ColMateri]}>
                ...
                <Text style={{ color: 'grey' }}>
                  Operator untuk operasi aritmetika tergolong sebagai <B>operator binary</B> yang artinya
                  operator-operator ini memerlukan satu operator untuk dua operand,
								</Text>
                <Image
                  source={require('../../../assets/images/aritmatika-binary.png')}
                  resizeMode='contain'
                  style={{ width: 320, marginBottom: 0, marginTop: 0 }}
                />
                <Text style={{ color: 'grey' }}>
                  Dan operator aritmetika juga mempunyai beberapa operator yang dapat bersifat unary, yaitu:
                </Text>
                <Image
                  source={require('../../../assets/images/aritmatika-unary.png')}
                  resizeMode='contain'
                  style={{ width: 320, marginBottom: 0, marginTop: 0 }}
                />
                <Grid>
            ...
            <Grid>
              ...
              <Col style={{ flex: 1, justifyContent: 'center', alignContent: 'center' }}>
                <Button style={[styles.nextButton, styles.midBut]} onPress={() => this.props.navigation.navigate('logikaScreen')}>
